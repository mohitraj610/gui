...
import arduinoNanoOldIconURL from './arduinoNanoOld/arduinoNano.png';
import arduinoNanoOldConnectionIconURLL from './arduinoNanoOld/arduinoNano-illustration.svg';
import arduinoNanoOldConnectionSmallIconURL from './arduinoNanoOld/arduinoNano-small.svg';
...
const deviceData = [
    ...
    },
    {
        ...
        deviceId: 'arduinoNanoOld',
        manufactor: 'arduino.cc',
        // leanMore: 'https://store.arduino.cc/usa/arduino-nano',
        type: 'arduino',
        iconURL: arduinoNanoOldIconURL,
        description: (
            <FormattedMessage
                defaultMessage="The Arduino Nano Old is a classic small board to build your projects with."
                description="Description for the Arduino Nano Old device"
                id="gui.device.arduinoNanoOld.description"
            />
        ),
        featured: true,
        disabled: false,
        ...
        launchPeripheralConnectionFlow: true,
        useAutoScan: false,
        connectionIconURL: arduinoNanoOldConnectionIconURLL,
        connectionSmallIconURL: arduinoNanoOldConnectionSmallIconURL,
        connectingMessage: (
            <FormattedMessage
                defaultMessage="Connecting"
                description="Message to help people connect to their arduino."
