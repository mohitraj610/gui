...
class MenuBar extends React.Component {
    ...
    componentDidMount () {
        ...
        this.switchUploadMode();// for upload mode by indrajith T
    }
    ...
    redirectToWiingy(){
        // setTimeout(() => {
        //     this.handleProgramModeSwitchOnChange();
        // }, 1500);
        window.open("http://www.wiingy.com");
    }
    handleClickRemix () {
    ...
    handleProgramModeUpdate (data) {
        ...
        if(this.state.isFirstLoading==false && data.isRealtimeMode==true){
    ...
    switchUploadMode(){//custom function for Upload mode by indrajith 
        this.props.onSetUploadMode();
        this.props.vm.runtime.setRealtimeMode(false);
        this.props.onSetStageHide();
    }
    handleDownloadFirmware () {
        if (this.props.deviceId) {
            ...
            >
                <div className={styles.mainMenu}>
                    <div className={classNames(styles.menuBarItem)}>
                        <h1 onClick={this.redirectToWiingy}>WiinBlock</h1>
                    </div>
                    {
